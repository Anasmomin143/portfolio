    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="text-center relative">
        ...
        <FadeIn delay={0.2}>
          <div className="mb-8">
            <ScaleIn delay={0.4}>
              <span className="inline-flex items-center rounded-full px-4 py-2 text-sm font-medium shadow-soft" style={{ background: 'var(--gradient-secondary)', color: 'var(--color-primary)', borderColor: 'var(--color-primary)' }}>
        ...
        <ScaleIn delay={1.0}>
          <p className="mt-4 text-sm font-semibold px-3 py-1 rounded-full inline-block" style={{ color: 'var(--color-primary)', background: 'var(--gradient-secondary)', borderColor: 'var(--color-primary)' }}>
        ...
        <StaggerItem>
          <HoverCard scaleOnHover={1.08} rotateOnHover={2}>
            <div className="group text-center p-6 rounded-2xl hover:shadow-medium transition-all duration-300" style={{ background: 'var(--gradient-card)', borderColor: 'var(--color-primary)' }}>
              ...
              <h3 className="mt-6 text-xl font-bold" style={{ color: 'var(--color-text)' }}>⚡ Fast Performance</h3>
        ...
        <StaggerItem>
          <HoverCard scaleOnHover={1.08} rotateOnHover={-2}>
            <div className="group text-center p-6 rounded-2xl hover:shadow-medium transition-all duration-300" style={{ background: 'var(--gradient-card)', borderColor: 'var(--color-accent)' }}>
              ...
              <h3 className="mt-6 text-xl font-bold" style={{ color: 'var(--color-text)' }}>📱 Responsive Design</h3>
        ...
        <StaggerItem>
          <HoverCard scaleOnHover={1.08} rotateOnHover={2}>
            <div className="group text-center p-6 rounded-2xl hover:shadow-medium transition-all duration-300" style={{ background: 'var(--gradient-card)', borderColor: 'var(--color-secondary)' }}>
              ...
              <h3 className="mt-6 text-xl font-bold" style={{ color: 'var(--color-text)' }}>✨ Quality Code</h3>
